#!/usr/bin/env bash
# =============================================================================
# build.sh — Build the native mazer Rust library for the host machine.
#
...
#      ./native/, which is where cffi (Stage 2) will look for them.
#
...
# (`./build.sh`, `bash build.sh`, `~/proj/build.sh`, etc.). Anchor everything
